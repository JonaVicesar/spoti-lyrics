const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .err {
    ...
    border: 1px solid #2e1010; border-radius: var(--radius);
  ...
  .brand-sub { font-size: 10px; color: var(--accent); letter-spacing: 3px; margin-bottom: 32px; }
  ...
  .result-cover {
    ...
    object-fit: cover; flex-shrink: 0; background: #1e1e1e;
  }
  ...
  /* ── EDITOR VIEW ── */
  .editor-view { flex: 1; display: flex; flex-direction: column; min-height: 100vh; }
  ...
  .editor-cover { width: 36px; height: 36px; border-radius: 5px; object-fit: cover; flex-shrink: 0; }
  ...
  .editor-body {
    flex: 1; display: grid; padding: 20px;
  ...
  /* ── LYRICS ── */
  .lyrics-scroll { max-height: 420px; overflow-y: auto; padding-right: 2px; }
